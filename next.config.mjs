        ...
        headers: [
          ...
          // Prevent XSS attacks — only allow scripts/styles from trusted sources
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.mapbox.com https://*.mapbox.cn https://api.mapbox.com https://events.mapbox.com https://geocode.arcgis.com https://*.cartocdn.com https://basemaps.cartocdn.com",
