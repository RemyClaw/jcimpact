...
def regenerate_stats(data):
    ...
    labels = {'2026-01': "January 2026", '2026-02': "February 2026", '2026-03': "March 2026", '2026-04': "April 2026"}
    ...
    # Keep the display label format already in use in data.json
    ...
    for k in sorted(by_month.keys()):
        ...
        new_trends.append({
            'month': k,
            'label': existing_labels.get(k, labels.get(k, k)),
